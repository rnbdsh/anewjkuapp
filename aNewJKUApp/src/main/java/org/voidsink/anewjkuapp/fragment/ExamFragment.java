...
public class ExamFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.fragment_card_exam, container, false);

        mListView = (StickyCardListView) view.findViewById(R.id.exam_list);
