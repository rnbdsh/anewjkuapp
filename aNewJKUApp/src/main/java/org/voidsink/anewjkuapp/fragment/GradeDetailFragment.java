...
public class GradeDetailFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.fragment_card_grade_detail, container,
                false);

        mListView = (StickyCardListView) view.findViewById(R.id.grade_card_list);
